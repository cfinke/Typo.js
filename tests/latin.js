function run() {
	...
	var affData = utilityDict._readFile(chrome.runtime.getURL("tests/dictionaries/la/la.aff"));
	var wordData = utilityDict._readFile(chrome.runtime.getURL("tests/dictionaries/la/la.dic"));
